...
<div className="content">
	...
	<div className="d-main gray">
		<div className="top-picture f-w-1025">
			<div className="b-01 dyson">dyson <span className="model-gray">airblade</span> <span className="model-lightgray">wash+dry</span></div>
			<div className="b-02 mont">Мойте и высушивайте руки прямо над раковиной
				<a href="">Купить</a></div>
			<img className="mask-bottom b-03" src={wd0101s} />
		</div>
	</div>
	...
	<div className="pictures">
			<div className="picture-l f-w-1025 wd02">
				<div className="pict-p">
					<img className="for-mob mask-bottom" src={wd02s} />
				</div>
			...
			<div className="picture-r f-w-1025 mask-right wd03">
				<div className="pict-p">
					<img className="for-mob" src={wd03s} />
				</div>
				<div className="pict-t">
			...
			<div className="picture-l f-w-1025 mask-left wd04">
				<div className="pict-p">
					<img className="for-mob" src={wd04s} />
				</div>
				<div className="pict-t">
	...
	<div className="black">
		<div className="f-w-1025 middle">
			<div className="pictures picture-l wd05">
				<div className="pict-p">
					<img className="mask-bottom for-mob" src={wd05s} />
				</div>
				<div className="pict-t">
					<h3>Фильтры HEPA</h3>
