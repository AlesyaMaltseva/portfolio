...
<div className={dyson.content}>
	...
	<div className={dyson.pictures}>
		<div className={[dyson.pictureR]+' '+[dyson.fw1025]+' '+[dyson.kj902]}>
			<div className={dyson.pictP}>
				 <img className={dyson.forMob} src={kj902S} />
			</div>
		...
		<div className={[dyson.pictureL]+' '+[dyson.fw1025]+' '+[dyson.kj903]}>
			<div className={dyson.pictP}>
				 <img className={dyson.forMob} src={kj903S} />
			</div>
			<div className={dyson.pictT}>
		...
		<div className={[dyson.pictureR]+' '+[dyson.fw1025]+' '+[dyson.kj904]}>
			<div className={dyson.pictP}>
				 <img className={dyson.forMob} src={kj904S} />
			</div>
			<div className={dyson.pictT}>
	...
	<div className={dyson.black}>
		<div className={[dyson.fw1025]+' '+[dyson.middle]}>		
			<div className={[dyson.pictures]+' '+[dyson.pictureL]+' '+[dyson.kj905]}>
				<div className={dyson.pictP}>
					 <img className={dyson.forMob} src={kj905S} />
				</div>
				<div className={dyson.pictT}>
					<h3>Фильтр HEPA</h3>
			...
			<div className={[dyson.pictures]+' '+[dyson.pictureR]+' '+[dyson.kj906]}>
				<div className={dyson.pictP}>
					 <img className={[dyson.maskBottom]+' '+[dyson.forMob]} src={kj906S} />
				</div>
				<div className={dyson.pictT}>
			...
			<div className={[dyson.pictures]+' '+[dyson.pictureL]+' '+[dyson.kj907]}>
				<div className={dyson.pictP}>
					 <img className={dyson.forMob} src={kj907S} />
				</div>
				<div className={dyson.pictT}>
